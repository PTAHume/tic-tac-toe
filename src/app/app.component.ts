...
export class AppComponent implements OnInit {
  ...
  hasWinner(): boolean {
    if (
      //check vertically
      (this.boxes[0].value === this.player &&
        this.boxes[1].value === this.player &&
        this.boxes[2].value === this.player) ||
      (this.boxes[3].value === this.player &&
        this.boxes[4].value === this.player &&
        this.boxes[5].value === this.player) ||
      (this.boxes[6].value === this.player &&
        this.boxes[7].value === this.player &&
        this.boxes[8].value === this.player) ||
      //check horizontally
      (this.boxes[0].value === this.player &&
        this.boxes[3].value === this.player &&
        this.boxes[6].value === this.player) ||
